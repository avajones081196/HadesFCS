...
if __name__ == '__main__':
    ...
    orig  = sys.argv[1] if len(sys.argv) > 1 else os.path.join(BASE_DIR, "original_Hades.net")
    skidl = sys.argv[2] if len(sys.argv) > 2 else os.path.join(BASE_DIR, "Hades.net")
    report = os.path.join(BASE_DIR, "Hades_validation.txt")
    class _Tee:
