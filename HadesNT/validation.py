...
if __name__ == '__main__':
    ...
    orig  = sys.argv[1] if len(sys.argv) > 1 else os.path.join(BASE_DIR, "original_HadesNT.net")
    skidl = sys.argv[2] if len(sys.argv) > 2 else os.path.join(BASE_DIR, "HadesNT.net")
    report = os.path.join(BASE_DIR, "HadesNT_validation.txt")
    class _Tee:
